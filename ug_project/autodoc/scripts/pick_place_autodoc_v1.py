...
# #bruise
    ...
    # object_4.position.x = -0.741
    # object_4.position.y = -0.242
    # object_4.position.z = 0.631
    # quaternion_4 = quaternion_from_euler(-1.601,-0.057,1.681)
...
#go above cotton
    ...
    # object_6.position.x =  0.581
    # object_6.position.y =  0.599
    # object_6.position.z = 0.6295
    # quaternion_6 = quaternion_from_euler(-1.512,-0.028, 0.061)
